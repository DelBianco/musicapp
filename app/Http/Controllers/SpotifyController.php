...
class SpotifyController extends Controller
{
    ...
    public function retrieveData(\GuzzleHttp\Client $httpClient, Request $request)
    {
        ...
        $top = $this->spotifyRequest($httpClient,"https://api.spotify.com/v1/me/top/artists?time_range=short_term&limit=5");
        foreach ($top->items as $item) {
            ...
            if($artist == null){
                ...
                $artist->save();
                $albums = $this->spotifyRequest($httpClient,"https://api.spotify.com/v1/artists/".$item->id."/albums?limit=5");
